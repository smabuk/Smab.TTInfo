...
{
	private string CACHEFILE_PREFIX      => WebsiteVersion == TT365WebsiteVersion.Original ? "tt365_old_" : "tt365_new2026_";
	private string TT365_COM             => $"""https://{(WebsiteVersion == TT365WebsiteVersion.Original ? "old" : "www")}.tabletennis365.com""";
